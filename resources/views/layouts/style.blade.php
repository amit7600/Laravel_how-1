...
<head>
  ...
  <link href="http://www.crystaleyebrow.com/components/dialog-box/jquery-confirm.css" rel="stylesheet" type="text/css">
  <script src="http://www.crystaleyebrow.com/components/dialog-box/jquery-confirm.js"></script>
  ...
  <script type='text/javascript'
    src='//platform-api.sharethis.com/js/sharethis.js#property=5d162f2d55a8b200110cde49&product=inline-share-buttons'
    async='async'></script>
  @if($map && $map->active == 0)
