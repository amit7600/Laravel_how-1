        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <div class="form-group m-form__group row">
              ...
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="occupation">Header Text for PDF Downloads
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <textarea id="summernote_pdf_header" type="text" name="header_pdf" class="optional form-control col-md-7 col-xs-12">{{$layout->header_pdf}}</textarea>
                </div>
              </div>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <textarea id="summernote_pdf_footer" type="text" name="footer_pdf" class="optional form-control col-md-7 col-xs-12">{{$layout->footer_pdf}}</textarea>
                </div>
              </div>

              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="occupation">Footer Text for CSV Downloads
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12"value for="occupation">Secondary Color
                </label>
                <div class="col-md-2 col-sm-6 col-xs-12">
...
$(document).ready(function() {
    ...
    $('#summernote_pdf_header').summernote({
        height: 200
    });
    $('#summernote_pdf_footer').summernote({
        height: 200
    });
});
