...
<div class="wrapper">
    ...
    <div id="organizations-edit-content" class="container">
        ...
        {!! Form::model($campaignConfirm,['route' => array('campaigns.update', $campaignConfirm->id),'class' =>
        'form-horizontal
        form-label-left','enctype' => 'multipart/form-data','method'=>'put']) !!}
        <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div id="religion-div" class="button_dropdown">
                        {!! Form::select('group_id[]',$groupList,$grouId,['class'
            ...
            <!-- <div class="form-group" id="schedule">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 organization-details-div">
                    {!! Form::text('schedule_date',null,['class'=> 'form-control selectpicker','id'=>'scheduleDate'])!!}
                </div>
            </div> -->
            ...
            <div class="form-group">
                <div class="col-md-12">
                    <!-- <button class="btn btn-danger btn-rounded" name="close"><i class="fa fa-times"></i> Close</button> -->
