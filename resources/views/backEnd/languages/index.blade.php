    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                'style' =>
                                'display:inline']) !!}
                                {{Form::button('<i class="fa fa-trash"></i>', array('type' => 'submit', 'class' => 'btn btn-danger btn-xs', 'data-placement' => 'top', 'data-original-title' => 'Delete', 'onclick'=>'confirm(Are you sure to delete this religion)'))}}
                                {!! Form::close() !!}
                ...
                @if (Sentinel::getUser()->hasAccess(['religion.destroy']))
