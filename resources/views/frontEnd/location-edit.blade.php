...
<style type="text/css">
    ...
    button[data-id="facility_facility_type"] {
        height: 100%;
        border: 1px solid #ddd;
    }
...
<div class="wrapper">
    <div id="facilities-edit-content" class="container">
        ...
        {!! Form::model($facility,['route' => ['facility.update',$facility->location_recordid],'method' => 'PUT']) !!}
        <div class="row">
            <div class="form-group">
                <label class="control-label sel-label-org pl-4">Name: </label>
                <div class="col-md-12 col-sm-12 col-xs-12 facility-details-div">
                    <input class="form-control selectpicker" type="text" id="facility_location_name"
                        name="facility_location_name" value="{{$facility->location_name}}">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label sel-label-org pl-4">Organization: </label>
                <div class="col-md-12 col-sm-12 col-xs-12 facility-details-div">
                    {{-- <select class="form-control selectpicker" data-live-search="true" id="facility_organization_name"
                        name="facility_organization_name">
                        @foreach($organization_name_list as $key => $org_name)
                        <option value="{{$org_name}}" @if ($facility_organization_name==$org_name) selected @endif>
                    {{$org_name}}</option>
                    @endforeach
                    </select> --}}
                    {!!
                    ...
                    => 'form-control
                    selectpicker','id' => 'facility_organization_name' ,'placeholder' => 'Select facility type']) !!}
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 facility-details-div">
                    {{-- <fieldset id="facility_facility_type">
                            ...
                            <input type="radio" value="0" name="facility_facility_type" checked> Faith-Based-Service
                            Provider<br>
                            @else
                            <input type="radio" value="0" name="facility_facility_type"> Faith-Based-Service
                            Provider<br>
                            @endif
                    ...
                    {!! Form::select('facility_facility_type',$facility_facility_type,$facility->location_type,['class'
                    => 'form-control
                    selectpicker','id' => 'facility_facility_type' ,'placeholder' => 'Select facility type']) !!}
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 facility-details-div">
                    <select class="form-control selectpicker" data-live-search="true" id="facility_address_city"
                        ...
                        <option value="{{$address_city}}" @if ($location_address_city==$address_city) selected @endif>
                            {{$address_city}}</option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 facility-details-div">
                    <input class="form-control selectpicker" type="text" id="facility_zip_code" name="facility_zip_code"
            ...
            <div class="form-group">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 facility-details-div">
                    <input class="form-control selectpicker" type="text" id="facility_congregation"
                        name="facility_congregation" value="{{$facility->location_congregation}}">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label sel-label-org pl-4">Building Status: </label>
                <div class="col-md-12 col-sm-12 col-xs-12 facility-details-div">
                    <select class="form-control selectpicker" data-live-search="true" id="facility_building_status"
                        name="facility_building_status">
                        @foreach($building_status_list as $key => $building_status)
                        <option value="{{$building_status}}" @if ($facility->location_building_status ==
                            $building_status) selected @endif>{{$building_status}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 facility-details-div">
                    <select class="form-control selectpicker" data-live-search="true" id="facility_facility_call"
                        name="facility_facility_call">
                        @foreach($facility_call_list as $key => $facility_call)
                        <option value="{{$facility_call}}" @if ($facility->location_call == $facility_call ||
                            ($facility->location_call == '-' && $facility_call == 'unknown')) selected
                            @endif>{{$facility_call}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 facility-details-div">
                    <input class="form-control selectpicker" type="textarea" , rows="10" cols="30"
                        id="facility_location_comments" name="facility_location_comments"
                        value="{{$facility->location_description}}">
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-12 text-center">
                    <a href="/facility/{{$facility->location_recordid}}" class="btn btn-info btn-rounded"
                        id="view-facility-btn"><i class="fa fa-arrow-left"></i> Back</a>
                    <button class="btn btn-danger delete-td" id="delete-facility-btn"
                        value="{{$facility->location_recordid}}" data-toggle="modal"
