        ...
        <div class="row">
            ...
            <div class="form-group">
                <div class="col-md-12 col-sm-12 col-xs-12 group-details-div">
                    ...
                    <p><b>Religion:</b> {{json_decode($filters_json)->religion_name}}</p>
                    @endif
                    @if (json_decode($filters_json)->faith_tradition_filter != null)
                    <p><b>Faith Tradition:</b> {{json_decode($filters_json)->faith_tradition_name}}</p>
                    @endif
                    @if (json_decode($filters_json)->denomination_filter != null)
                    <p><b>Denomination:</b> {{json_decode($filters_json)->denomination_name}}</p>
                    @endif
                    @if (json_decode($filters_json)->judicatory_body_filter != null)
                    <p><b>Judicatory Body:</b> {{json_decode($filters_json)->judicatory_body_name}}</p>
                    @endif
