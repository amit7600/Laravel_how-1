                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 facility-details-div">
                        <input class="form-control selectpicker" type="text" id="facility_location_name"
                            name="facility_location_name" value="">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 facility-details-div">
                        {{-- <select class="form-control selectpicker" data-live-search="true"
                            id="facility_organization_name" name="facility_organization_name">
                            @foreach($organization_name_list as $key => $org_name)
                            <option value="{{$org_name}}">{{$org_name}}</option>
                        @endforeach
                        </select> --}}
                        {!!
                        Form::select('facility_organization_name',$organization_names,'',['class'
                        => 'form-control
                        selectpicker','id' => 'facility_organization_name' ,'placeholder' => 'Select organization'])
                        !!}
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 facility-details-div">
                        ...
                        {!! Form::select('facility_facility_type',$facility_facility_type,null,['class' => 'form-control
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 facility-details-div">
                        <input class="form-control selectpicker" type="text" id="facility_congregation"
                            name="facility_congregation" value="">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 facility-details-div">
                        <input class="form-control selectpicker" type="textarea" rows="10" cols="30"
                            id="facility_location_comments" name="facility_location_comments" value="">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-12 text-center">
                        <a href="/facilities" class="btn btn-info btn-rounded" id="view-facility-btn"><i
