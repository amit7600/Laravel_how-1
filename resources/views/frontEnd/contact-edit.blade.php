...
<div class="wrapper">
    <div id="contacts-edit-content" class="container">
        ...
        <div class="form-group delete-btn-div">
            <button class="btn btn-danger delete-td" id="delete-contact-btn" value="{{$contact->contact_recordid}}" data-toggle="modal" data-target=".bs-delete-modal-lg"><i class="fa fa-fw fa-remove"></i>Delete</button>
        </div>
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 contact-details-div">
                        <input class="form-control selectpicker"  type="text" id="contact_first_name" name="contact_first_name" value="{{$contact->contact_first_name}}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label sel-label-org pl-4">Middle Name: </label>
                    <div class="col-md-12 col-sm-12 col-xs-12 contact-details-div">
                        <input class="form-control selectpicker"  type="text" id="contact_middle_name" name="contact_middle_name" value="{{$contact->contact_middle_name}}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label sel-label-org pl-4">Last Name: </label>
                    <div class="col-md-12 col-sm-12 col-xs-12 contact-details-div">
                        <input class="form-control selectpicker"  type="text" id="contact_last_name" name="contact_last_name" value="{{$contact->contact_last_name}}">    
                    </div>
                </div>
                <div class="form-group">                 
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 contact-details-div">
                        <select class="form-control selectpicker" data-live-search="true" id="contact_type" name="contact_type">
                            @foreach($contact_types as $key => $type)                                
                                <option value="{{$type->contact_type}}" @if ($contact->contact_type == $type->contact_type) selected @endif>{{$type->contact_type}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="form-group">                 
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 contact-details-div">
                        <select class="form-control selectpicker" data-live-search="true" id="contact_organization_name" name="contact_organization_name">
                            @foreach($organization_name_list as $key => $org_name)                                
                                <option value="{{$org_name}}" @if ($contact_organization_name == $org_name) selected @endif>{{$org_name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 contact-details-div">
                        <select class="form-control selectpicker" multiple data-live-search="true" id="contact_languages_spoken" name="contact_languages_spoken[]">
                        @foreach($contact_languages as $key => $contact_language)
                            <option value="{{$contact_language}}" @if (strpos($contact->contact_languages_spoken, $contact_language) !== false) selected @endif>{{$contact_language}}</option>
                        @endforeach
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 contact-details-div">
                        <input class="form-control selectpicker"  type="text" id="contact_other_languages" name="contact_other_languages" value="{{$contact->contact_other_languages}}">
                    </div>
                </div> 
                <div class="form-group">
                    <label class="control-label sel-label-org pl-4">Religious Title: </label>
                    <div class="col-md-12 col-sm-12 col-xs-12 contact-details-div">
                        <input class="form-control selectpicker"  type="text" id="contact_religious_title" name="contact_religious_title" value="{{$contact->contact_religious_title}}">    
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label sel-label-org pl-4">Pronouns: </label>
                    <div class="col-md-12 col-sm-12 col-xs-12 contact-details-div">
                        <select class="form-control selectpicker" data-live-search="true" id="contact_pronouns" name="contact_pronouns">
                            @foreach($contact_pronoun_list as $key => $contact_pronoun)
                                <option value="{{$contact_pronoun}}" @if ($contact->contact_pronouns == $contact_pronoun) selected @endif>{{$contact_pronoun}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 contact-details-div">
                        <input class="form-control selectpicker"  type="text" id="contact_mailing_address" name="contact_mailing_address" value="{{$mailing_address}}">    
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 contact-details-div">
                        <input class="form-control selectpicker"  type="text" id="contact_office_phones" name="contact_office_phones" value="{{$office_phone_number}}">    
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label sel-label-org pl-4">Emergency Phone: </label>
                    <div class="col-md-12 col-sm-12 col-xs-12 contact-details-div">
                        <input class="form-control selectpicker"  type="text" id="contact_emergency_phones" name="contact_emergency_phones" value="{{$emergency_phone_number}}">    
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label sel-label-org pl-4">Office Fax: </label>
                    <div class="col-md-12 col-sm-12 col-xs-12 contact-details-div">
                        <input class="form-control selectpicker"  type="text" id="contact_office_fax_phones" name="contact_office_fax_phones" value="{{$office_fax_phone_number}}">    
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label sel-label-org pl-4">Personal Email: </label>
                    <div class="col-md-12 col-sm-12 col-xs-12 contact-details-div">
                        <input class="form-control selectpicker"  type="text" id="contact_personal_email" name="contact_personal_email" value="{{$contact->contact_personal_email}}">    
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label sel-label-org pl-4">Work Email: </label>
                    <div class="col-md-12 col-sm-12 col-xs-12 contact-details-div">
                        <input class="form-control selectpicker"  type="text" id="contact_email" name="contact_email" value="{{$contact->contact_email}}">    
                    </div>
                </div>
                <div class="form-group"> 
                    <div class="col-md-12">
