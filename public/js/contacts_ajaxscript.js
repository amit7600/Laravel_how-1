...
$(document).ready(function(){
    ...
    $(document).on('click','.open_modal',function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                // console.log(data);
                $('#id').val(data.contact_recordid);
                $('#contact_first_name').val(data.contact_first_name);
                $('#contact_middle_name').val(data.contact_middle_name);
                $('#contact_last_name').val(data.contact_last_name);
                $('#contact_organization_id').val(data.contact_organization_id);
                $('#contact_type').val(data.contact_type);
                $('#contact_languages_spoken').val(data.contact_languages_spoken);
                $('#contact_other_languages').val(data.contact_other_languages);
                $('#contact_religious_title').val(data.contact_religious_title);
                $('#contact_title').val(data.contact_title);
                $('#contact_pronouns').val(data.contact_pronouns);
                $('#contact_personal_email').val(data.contact_personal_email);
    ...
    // $("#btn-save").click(function (e) {
        ...
        var formData = {
            ...
            contact_organization_id: $('#contact_organization_id').val(),
            contact_type: $('#contact_type').val(),
            contact_languages_spoken: $('#contact_languages_spoken').val(),
            contact_other_languages: $('#contact_other_languages').val(),
            contact_religious_title: $('#contact_religious_title').val(),
            contact_title: $('#contact_title').val(),
            contact_pronouns: $('#contact_pronouns').val(),
            contact_personal_email: $('#contact_personal_email').val(),
