...
$(document).ready(function(){
    ...
    $(document).on('click','.open_modal',function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                // console.log(data);
                $('#id').val(data.address_recordid);
                $('#address').val(data.address);
                $('#address_1').val(data.address_1);
                $('#address_city').val(data.address_city);
                $('#address_state').val(data.address_state);
                $('#address_zip_code').val(data.address_zip_code);
                $('#address_id').val(data.address_id);
                $('#address_region').val(data.address_region);
                $('#address_country').val(data.address_country);
                $('#address_attention').val(data.address_attention);
    ...
    // $("#btn-save").click(function (e) {
        ...
        var formData = {
            ...
            address_attention: $('#address_attention').val(),
