...
$(document).ready(function(){
    ...
    $(document).on('click','.open_modal',function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#location_congregation').val(data.location_congregation);
                $('#location_building_status').val(data.location_building_status);
                $('#location_call').val(data.location_call);
                $('#location_description').val(data.location_description);
                $('#location_contact').val(data.location_contact);
    ...
    // $("#btn-save").click(function (e) {
        ...
        var formData = {
            ...
            location_congregation: $('#location_congregation').val(),
            location_building_status: $('#location_building_status').val(),
            location_call: $('#location_call').val(),
            location_description: $('#location_description').val(),
            location_contact: $('#location_contact').val()
        }
