...
$(document).ready(function(){
    ...
    $(document).on('click','.open_modal',function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#organization_alt_id').val(data.organization_alt_id);
                $('#organization_type').val(data.organization_type);
                $('#organization_url').val(data.organization_url);
                $('#organization_facebook').val(data.organization_facebook);
                $('#organization_internet_access').val(data.organization_internet_access);
                $('#organization_description').val(data.organization_description);
                $('#organization_borough').val(data.organization_borough);
    ...
    // $("#btn-save").click(function (e) {
        ...
        var formData = {
            ...
            organization_alt_id: $('#organization_x_uid').val(),
            organization_type: $('#organization_type').val(),
            organization_url: $('#organization_url').val(),
            organization_facebook: $('#organization_facebook').val(),
            organization_internet_access: $('#organization_internet_access').val(),
            organization_description: $('#organization_description').val(),
            organization_borough: $('#organization_borough').val(),
            organization_zipcode: $('#organization_zipcode').val()
        }
