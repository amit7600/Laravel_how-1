    ...
    public function airtable()
    {
        ...
        do {
            ...
            foreach ( $airtable_response['records'] as $record ) {
                ...
                $taxonomy->taxonomy_description = isset($record['fields']['description-x'])?$record['fields']['description-x']:null;
                $taxonomy->taxonomy_notes = isset($record['fields']['notes-x'])?$record['fields']['notes-x']:null;
                ...
                $taxonomy->taxonomy_id = isset($record['fields']['id'])?$record['fields']['id']:null;

                $taxonomy->taxonomy_parent_id = isset($record['fields']['parent_id'])?$record['fields']['parent_id']:null;
