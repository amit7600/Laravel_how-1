...
class LocationController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontEnd.location-create', compact('map', 'organization_name_list', 
            'address_address_list', 'address_city_list', 'address_zipcode_list', 'building_status_list'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('frontEnd.location-edit', compact('facility', 'map', 'organization_name_list', 'facility_organization_name', 
            'address_address_list', 'address_city_list', 'address_zipcode_list', 'location_address_city', 'location_street_address',
            'location_zip_code', 'building_status_list', 'facility_call_list'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($location->location_organization != $facility_organization_id) {
            ...
            $organization_name_old = Organization::where('organization_recordid', '=', $location->location_organization)->first()->organization_name;
